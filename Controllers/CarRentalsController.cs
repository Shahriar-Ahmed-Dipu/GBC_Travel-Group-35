...
namespace GBC_Travel_Group_35.Controllers
{
    public class CarRentalsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CarRentalId,Model,RentalCompany,Price,IsAvailable")] CarRental carRental)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CarRentalId,Model,RentalCompany,Price,IsAvailable")] CarRental carRental)
        {
