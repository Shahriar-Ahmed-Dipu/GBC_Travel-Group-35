...
VALUES (N'20240222222601_Initial', N'8.0.2');
GO
...
CREATE TABLE [CarRentals] (
    [CarRentalId] int NOT NULL IDENTITY,
    [Model] nvarchar(max) NOT NULL,
    [RentalCompany] nvarchar(max) NOT NULL,
    [Price] decimal(18,2) NOT NULL,
    [IsAvailable] bit NOT NULL,
    CONSTRAINT [PK_CarRentals] PRIMARY KEY ([CarRentalId])
);
GO
...
INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
VALUES (N'20240223085843_AddFlightHotelCarRentalModels', N'8.0.2');
GO
